...
public class Splasher : MonoBehaviour
{
    ...
    private void Start() { 
        ...
        if (GetComponent<Collider>() == null)
        {
            ...
            Debug.LogWarning(string.Format("[Splasher.cs] Object \"{0}\" had no collider. MeshCollider has been added.", name));
        }
        ...
        if (GetComponent<Rigidbody>() == null)
        {
            ...
            Debug.LogWarning(string.Format("[Splasher.cs] Object \"{0}\" had no Rigidbody. Rigidbody has been added.", name));
        }
    ...
    private void FixedUpdate()
    {
        ...
        for(int i=0; i<length; ++i)
        {
            ...
            if (wp.y - voxelHalfHeight < waterLevel)
            {
                ...
                Vector3 force = localDampingForce + Mathf.Sqrt(k)*(normal*/*localArchimedesForce*/ 1);
